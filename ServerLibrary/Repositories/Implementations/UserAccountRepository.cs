...
namespace ServerLibrary.Repositories.Implementations
{
    ...
    {
        public async Task<GeneralResponse> CreeateAsync(Register user)
        {
            if(user is null)
            {
        ...
        public async Task<LoginResponse> RefreshTokenAsync(RefreshToken token)
        {
            ...
            if (user is null)
            {
                return new LoginResponse(false, "Reshred could not be generated : User not found");
            }
            ...
            {
                return new LoginResponse(false, "refresh toklen could not gen : user not signed in");
            }
